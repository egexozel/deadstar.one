...
let blogName = "deadstar.one";
let authorName = "Ege Özel";
let authorLink = "https://twitter.com/egeozel"; // Enter your website, social media, etc. Some way for people to tell you they like your blog! (Leaving it empty is okay too)
...
let postsArray = [
    ["posts/2022-07-08-Gemini-Protocol.html"],
    ["posts/2022-05-27-On-Processing-Loss.html"],
    ["posts/2022-02-27-Love-Trip.html"],
    ["posts/2022-02-19-Hello-World.html"]];
...
'<li><a href="' + relativePath + '/now.html">Now</a></li></ul>';
...
function numberWithCommas(num) {
  return num.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',');
	...
	function startTime() {
		...
		let stars = (3182 * secs);
		let starsc = numberWithCommas(stars);
        document.getElementById('strs').innerHTML =  starsc + " stars have died today.";
        setTimeout(startTime, 1000);
}

let footerHTML = "<hr><p>" + blogName + " is written by <a href='" + authorLink + "'>" + authorName + "</a></p>";
